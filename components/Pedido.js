...
const Pedido = ({pedido}) => {
    ...
    return ( 
        <div className={` ${clase} border-t-4 mt-4 bg-white rounded p-6 md:grid md:grid-cols-3 md:gap-4 shadow-lg`}>
            <div>
                ...
                {cedula && (
                    <p className="flex items-center my-2">
                       <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"></path></svg> {cedula}
                    </p>
                )}
            ...
            <div>
                <h2 className="text-gray-800 font-bold mt-3">Resumen del Pedido</h2>
            ...
            <div>
                <h2 className="text-gray-800 font-bold mt-3">Fecha de compra</h2>
                {newDate && (
                    <p className="flex items-center my-2">
